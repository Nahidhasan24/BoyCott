...
public class SearchActivity extends AppCompatActivity {
    ...
    private void showSearchableSpinnerDialog(List<String> items, OnItemSelectedListener listener) {
        Dialog dialog = new Dialog(SearchActivity.this, R.style.CustomDialogTheme);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getApplicationContext(), R.layout.custom_list_item, itemsWithRemoveOption);
